...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/public/zs/npc/custom_dataset/")
    # parser.add_argument("--data_dir", default="data")
    # TODO!!:选择不同的数据集进行实验，使用custom则表明使用的私人数据集,同时也要修改--data_dir的参数。
    parser.add_argument("--dataset", default="custom")
    # parser.add_argument("--dataset", default="AG_NEWS")
    #TODO!!:该参数表明分别从测试集和训练集中抽取的问题的数量
    ...
    # parser.add_argument("--compressor", default="lzma")
    # parser.add_argument("--compressor", default="bz2")
        ...
        if args.test_idx_fn is not None:
            try:
                ...
                for i in range(len(test_data)):
                    print(test_data[i] + str(test_labels[i]) + "\n")
