...
def load_custom_dataset(directory: str, delimiter: str = "\t") -> tuple:
    ...
    # test_fn = os.path.join(directory, "test1.txt")
    # test_fn = os.path.join(directory, "test3.txt")
    test_fn = os.path.join(directory, "test5.txt")
    # test_fn = os.path.join(directory, "test.txt")
    # test_fn = os.path.join(directory, "test.txt")
    # train_fn = os.path.join(directory, "train.txt")
    # train_fn = os.path.join(directory, "train1.txt")
    # train_fn = os.path.join(directory, "train3.txt")
    # train_fn = os.path.join(directory, "train1.txt")
    train_fn = os.path.join(directory, "train.txt")
    # train_fn = os.path.join(directory, "train.txt")
    train_ds, test_ds = process(train_fn), process(test_fn)
